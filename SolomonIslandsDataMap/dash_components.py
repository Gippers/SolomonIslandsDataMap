...
# %% auto 0
__all__ = ['define_map', 'gen_bar_plot', 'gen_dash_grid', 'gen_kpi', 'gen_dd', 'gen_pyramid']
...
def gen_kpi(sg:SolomonGeo, # Input data object
    ...
    text = dcc.Markdown(children = measure + " Projected Population in " + str(year) + " for current selection")
