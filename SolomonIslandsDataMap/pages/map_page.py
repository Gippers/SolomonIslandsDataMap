...
# %% auto 0
__all__ = ['init_load', 'init_init', 'layout', 'initial_load', 'load_dd_values', 'persist_dd_values', 'map_click',
...
try:
    ...
    from SolomonIslandsDataMap.app_data import mytitle, map_graph, selectedBarGraph, stored_data, dropdown_location \
        , control_type, dd_var, dd_measure, dropdown_geo, sidebar_census, dd_test
