...
# %% auto 0
__all__ = ['init_load', 'init_init', 'layout', 'trigger_initial', 'initial_load', 'geo_load', 'persist_dd_values', 'map_click',
           'map_selections', 'update_geography', 'update_measure', 'bar_click', 'update_map', 'update_bargraph']
...
def geo_load(page_trigger:str, # Page that triggered initial load
    ...
    return val_state['geo'], geo_disable
