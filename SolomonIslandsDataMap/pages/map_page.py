...
# %% auto #0
__all__ = ['init_init', 'dict_sol', 'layout', 'navClick', 'map_click', 'map_selections', 'update_geography', 'update_measure',
           'bar_click', 'update_map', 'update_bargraph']

# %% ../../nbs/03_map_page.ipynb #cb54578c
...
# %% ../../nbs/03_map_page.ipynb #f5222637
...
# %% ../../nbs/03_map_page.ipynb #4c548870
dict_sol = stored_data.data

# %% ../../nbs/03_map_page.ipynb #4273799f
clientside_callback(
    """
...
# %% ../../nbs/03_map_page.ipynb #df3a33d1
@callback(
...
# %% ../../nbs/03_map_page.ipynb #3e6b9a77
clientside_callback(
    """
...
# %% ../../nbs/03_map_page.ipynb #ce79ea93
clientside_callback(
    """
...
# %% ../../nbs/03_map_page.ipynb #cf2db55c
@callback(
...
# %% ../../nbs/03_map_page.ipynb #84f264f9
...
# %% ../../nbs/03_map_page.ipynb #e12cdc42
@callback(
...
# %% ../../nbs/03_map_page.ipynb #103f5c6e
@callback(
...
# %% ../../nbs/03_map_page.ipynb #17ba6e83
@callback(
...
# %% ../../nbs/03_map_page.ipynb #62c625c4
@callback(
    Output('map', 'figure', allow_duplicate=True),
    Input("segmented_geo", 'value'),
...
# %% ../../nbs/03_map_page.ipynb #8d0ee1a7
