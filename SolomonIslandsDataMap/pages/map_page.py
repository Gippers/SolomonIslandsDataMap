...
# %% auto 0
__all__ = ['init_init', 'layout', 'maintain_sidebar', 'persist_shared_values', 'map_click', 'map_selections', 'update_geography',
...
def layout():
    return  mytitle, map_graph, selectedBarGraph, stored_data, init_init
