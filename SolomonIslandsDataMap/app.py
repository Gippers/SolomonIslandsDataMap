...
# %% auto 0
__all__ = ['sol_geo', 'geo_df', 'app', 'server', 'geos', 'cen_vars', 'mytitle', 'map_graph', 'cards', 'dd', 'dropdown_geo',
...
dd = dcc.Dropdown(options=locations,
                        value=None,  # initial value displayed when page first loads
                        searchable=True,
                        clearable=True,
                        placehoder='Search for a location or click the map')
