...
__all__ = ['sol_geo', 'geo_df', 'app', 'server', 'geos', 'cen_vars', 'mytitle', 'map_graph', 'dropdown_geo', 'dropdown_var',
           'navbar', 'SIDEBAR_STYLE', 'sidebar', 'define_map', 'create_card', 'update_geography', 'update_kpis']
...
def create_card(sg:SolomonGeo, # Input data object
                agg:str, #Desired aggregation of card
    ...
    base_card = dbc.Card(
        ...
        dbc.CardBody(
            [
            html.H5(sg.get_df(agg_filter = 'province', 
