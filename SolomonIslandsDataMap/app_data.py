...
# %% auto 0
__all__ = ['sol_geo', 'geo_df', 'fig', 'geos', 'cen_vars', 'NUM_GEOS', 'stored_data', 'dropdown_location', 'dropdown_geo',
...
# TODO change back to above later, for now get working with defualt data
stored_data = sol_geo
